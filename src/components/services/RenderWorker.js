...
const displayUser=props.list.length > 0 &&
    props.list2.length > 0 &&
    props.filterlist.slice(pagesVisited, pagesVisited + usersPerPage).map((item) => {
            ...
            >
              ...
              <div class="rt-profile-body">
                ...
                <div class="rt-profile-text">
                  <p style={{ color: "white"  ,fontWeight:"800",textTransform:"capitalize",fontSize:"20px"}}><span style={{ color:"black" ,fontWeight:"800"}}>workType :</span> {item.workType}</p>
                  <p style={{ color: "white",fontWeight:"800" ,textTransform:"capitalize",fontSize:"20px"}}><span style={{ color: "black" ,fontWeight:"800"}}>location :</span>{item.location}</p>
                  <Button
                    variant="warning"
                    style={{ display: "inline", width: "130px" ,borderRadius:"15px"}}
                    onClick={() => {
  ...
  return (
    <>
     ...
     <div style={{display:"flex",justifyContent:"center",margin:"100px auto 80px auto"}}>
